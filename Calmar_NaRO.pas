...
constructor TCalmarNaR.Create(nrn: TNeuron);
begin      inherited Create; oN:=nrn;    end;

procedure TCalmarNaR.tau_inf(v2 :double; var tau_m,m_inf,tau_h,h_inf :double);
var v3,a,b :double;
begin
  v3:= v2 - oN.NP.Tr_NaR;
  a:= oN.NP.a1NaR * alphabeta(oN.NP.a2NaR-v3, oN.NP.a3NaR,oN.NP.a4NaR);
  b:= oN.NP.b1NaR * alphabeta(oN.NP.b2NaR-v3, oN.NP.b3NaR,oN.NP.b4NaR);
  tau_m:= 1 / (a + b);
  m_inf:= a / (a + b);
  a:= oN.NP.c1NaR * alphabeta  (oN.NP.c2NaR-v3, oN.NP.c3NaR,oN.NP.c4NaR);
  b:= oN.NP.d1NaR * alphabeta_h(oN.NP.d2NaR-v3, oN.NP.d3NaR,oN.NP.d4NaR);
  tau_h:= 1 / (a + b);
  h_inf:= a / (a + b);
end;

function TCalmarNaR.Conductance(x,y,z :double):double;
begin
  Conductance :=istep(x,3)*y*(1-oN.NP.IfBlockNaR);
end;

function TCalmarNaR.Current:double;
