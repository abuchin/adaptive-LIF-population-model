...
procedure New_m3(al,beta,dt,T :double; var m,U :double);
...
procedure New_m2(al,beta,dt,T :double; var m,U :double);
{
  ...
  or equivalent system:  dm/dt = U
                         dU/dt + (al+beta) U + al beta m= al beta (T/m_max-m)
...
procedure New_m3(al,beta,dt,T :double; var m,U :double);
{
  Step of eq.  ddm/ddt + al beta m = al beta T/m_max
  or equivalent system:  dm/dt = S
                         dS/dt = al beta (T/m_max - m)
  Maximum here does not depend on al,beta! }
var m_max :double;
begin
